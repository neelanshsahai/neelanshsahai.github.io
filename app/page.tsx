    ...
    <div className="min-h-screen flex flex-col bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark overflow-x-hidden">
      ...
      >
        ...
        <motion.section id="experience" variants={fadeInUp}>
          <ExperienceSection experience={RESUME_DATA.experience} isRemote={false} />
        </motion.section>
        
        <motion.section id="remote-experience" variants={fadeInUp}>
          <ExperienceSection experience={RESUME_DATA.remoteExperience} isRemote={true} />
        </motion.section>
